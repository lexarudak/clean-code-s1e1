...
var createNewTaskElement=function(taskString){
    ...
    editInput.classList.add("input-text", 'task-text');

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="task-list__edit";
    editButton.classList.add("button");

    deleteButton.className="task-list__remove";
    deleteButton.classList.add("button");
    deleteButtonImg.src='./remove.svg';
    deleteButtonImg.alt='remove button'
    deleteButtonImg.classList.add('task-list__remove-img')
...
//select ListItems children
    ...
    var deleteButton=taskListItem.querySelector(".task-list__remove");
